...
CFLAGS     = $(ARCHFLAGS) $(OPT) -ggdb -pipe -Wall -Wextra -Wno-main -Wno-unused-parameter -fdata-sections -ffunction-sections
ASFLAGS    = $(ARCHFLAGS)
CPPFLAGS   = -iquote '$(TOPDIR)SiliconLabs' -iquote '$(TOPDIR:%/=%)' -D$(CHIP)
LIBS       = -lc -lm -lnosys
